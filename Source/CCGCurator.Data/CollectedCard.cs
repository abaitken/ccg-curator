...
namespace CCGCurator.Data
{
    ...
    public class CollectedCard : NamedItem
    {
        ...
        public CollectedCard(string id, string name, CardQuality cardQuality, bool foil, int multiverseId, string setCode, string setName)
            : base(name)
        {
            Id = id;
